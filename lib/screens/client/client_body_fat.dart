...
class ClientBodyFat extends StatelessWidget {
  ClientBodyFat({super.key, required this.clientId});
          ...
          context.watch<HFGlobalState>().userAccessLevel == accessLevels.client
              ? Container(
                  ...
                  child: IconButton(
                    ...
                    onPressed: () {
                      Navigator.pushNamed(context, clientAddBodyFatRoute);
                    },
                  ),
                )
              : null,
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Column(
                            children: [
                              const HFHeading(
                                text: 'What is body fat percentage?',
                                size: 6,
                              ),
                              const SizedBox(
                                height: 10,
                              ...
                              const HFParagrpah(
                                text:
                                    'The body fat percentage (BFP) is the total mass of fat divided by total body mass, multiplied by 100; body fat includes essential body fat and storage body fat.',
                                size: 10,
                                maxLines: 99,
                              ),
                              const SizedBox(
