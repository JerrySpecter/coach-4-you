...
class ClientBmi extends StatelessWidget {
  ClientBmi({super.key, required this.clientId});
          ...
          context.watch<HFGlobalState>().userAccessLevel == accessLevels.client
              ? Container(
                  ...
                  child: IconButton(
                    ...
                    onPressed: () {
                      Navigator.pushNamed(context, clientAddBmiRoute);
                    },
                  ),
                )
              : null,
                        ...
                        Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              const HFParagrpah(
                                text:
                                    'The body mass index (BMI) or Quetelet Index is a measure of body weight, the weight of a person scaled according to height. It is used as a simple means of classifying sedentary individuals according to their body fat content.',
                                size: 10,
                                maxLines: 99,
                              ),
                              const SizedBox(
                              ...
                              if (data.docs.isNotEmpty)
                                ClientDataListTile(context, 'Current BMI:',
                                    '${data.docs[0]['value']}', () {}),
                              const SizedBox(
                                height: 30,
                              ),
                              const HFHeading(text: 'Past BMI', size: 6),
                              const SizedBox(
                                height: 10,
                              ),
                              Container(
          ...
          onPressed: () {
            docRef.delete().then((value) {
              ...
              ScaffoldMessenger.of(context)
                  .showSnackBar(getSnackBar(text: 'BMI deleted'));
            });
          },
          child: HFParagrpah(
            text: 'Delete',
